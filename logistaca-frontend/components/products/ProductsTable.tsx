...
export default function ProductsTable({
  ...
  const columns = [
    ...
    columnHelper.accessor('stock_quantity', { header: 'Stock' }),
  ...
  if (!data.length) return <div className="py-12 text-center text-muted-foreground">No hay productos registrados.</div>
