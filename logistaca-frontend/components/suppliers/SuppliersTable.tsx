...
const columnHelper = createColumnHelper<SupplierList>()
...
export default function SuppliersTable({
  ...
  const columns = [
    ...
    columnHelper.accessor('tax_id', { header: 'Tax ID' }),
  ...
  if (!data.length) return <div className="py-12 text-center text-muted-foreground">No hay proveedores registrados.</div>
